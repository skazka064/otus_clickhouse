#  Аналитика в реальном времени для Forex: интеграция пакетной и потоковой обработки с ClickHouse, Airflow и Kafka
...
flowchart LR
   ...
   |Поток|--> K[Kafka Topic<br>forex_ticks] --> Q[kafka_queue]
