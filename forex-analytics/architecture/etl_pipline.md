...
graph TD
    ...
    C -->|"MV: mv_predictions_eur_usd mv_predictions_gpb_usd mv_predictions_usd_jpy"| D["predictions_eur_usd predictions_gpb_usd predictions_usd_jpy<br>прогнозы EUR/USD GBP/USD USD/JPY"]
